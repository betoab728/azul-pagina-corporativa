...
const ui = {
  es: {
    ...
    'about.body': '¡Somos una empresa comprometida con el desarrollo sostenible, constituida como Sociedad BIC (Beneficio e Interés Colectivo). Brindamos servicios ambientales integrales con responsabilidad, innovación y respeto por nuestro entorno.',
  ...
  en: {
    ...
    'about.body': 'We are a company committed to sustainable development, established as a BIC Corporation (Benefit and Collective Interest). We provide comprehensive environmental services with responsibility, innovation and respect for our environment.',
  ...
  pt: {
    ...
    'about.body': 'Somos uma empresa comprometida com o desenvolvimento sustentável, constituída como Sociedade BIC (Benefício e Interesse Coletivo). Prestamos serviços ambientais integrais com responsabilidade, inovação e respeito pelo nosso entorno.',
